...
namespace MovieTicketManagementSystem.PresentationLayer
{
    public partial class AddMovieForm : UserControl
    {
        ...
        public void displayData()
        {
            ...
            List<MovieDTO> listData = mData.movieListData();
            ...
            try
            {
                using (SqlConnection connect = new SqlConnection(conn))
                {
                    ...
                    using(SqlCommand cID = new SqlCommand(checkID, connect))
                    {
                        ...
                        {
                            string insertData = "INSERT INTO Movie (movie_id, movie_name, genre, price, capacity, movie_image, status, created_at) " +
                                "VALUES(@movieID, @movieName, @genre, @price, @capacity, @movieImage, @status, @date)";

                            string path = Path.Combine(@"C:\MovieTicketBooking\MovieTicketManagementSystem\Movie_Directory\"
